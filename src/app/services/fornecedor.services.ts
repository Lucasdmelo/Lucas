...
export class FornecedorService {
  ...
  updateFornecedor(Fornecedor: Fornecedor): Observable<Fornecedor> {
    return this.httpClient.put<Fornecedor>(this.url + '/' + Fornecedor.cnpj, JSON.stringify(Fornecedor), this.httpOptions)
      .pipe(
        retry(1),
        catchError(this.handleError)
      )
  ...
  deleteFornecedor(Fornecedor: Fornecedor) {
    return this.httpClient.delete<Fornecedor>(this.url + '/' + Fornecedor.cnpj, this.httpOptions)
      .pipe(
        retry(1),
        catchError(this.handleError)
      )
