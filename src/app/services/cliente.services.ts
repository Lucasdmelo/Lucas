...
export class ClienteService {
  ...
  updateCliente(Cliente: Cliente): Observable<Cliente> {
    return this.httpClient.put<Cliente>(this.url + '/' + Cliente.cpf_cnpj, JSON.stringify(Cliente), this.httpOptions)
      .pipe(
        retry(1),
        catchError(this.handleError)
      )
  ...
  deleteCliente(Cliente: Cliente) {
    return this.httpClient.delete<Cliente>(this.url + '/' + Cliente.cpf_cnpj, this.httpOptions)
      .pipe(
        retry(1),
        catchError(this.handleError)
      )
